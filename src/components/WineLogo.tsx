export default function WineLogo({ className }: { className?: string }) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24" // Original viewBox fra filen
        className={className}
        fill="currentColor"   // Fargen styres av Tailwind (text-color)
      >
        <title>Wine Glass Logo</title>
